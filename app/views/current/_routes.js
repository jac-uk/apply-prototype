...
router.all('/submit-application/recorder/caution-conviction-router', function (req, res) {
...
router.all('/submit-application/recorder/penalty-notice-router', function (req, res) {
...
router.all('/submit-application/recorder/driving-offences-router', function (req, res) {
...
router.all('/submit-application/recorder/endorsement-notices-router', function (req, res) {
...
router.all('/submit-application/recorder/declared-bankrupt-router', function (req, res) {
...
router.all('/submit-application/recorder/late-returns-router', function (req, res) {
...
router.all('/submit-application/recorder/professional-proceeds-router', function (req, res) {
...
router.all('/submit-application/recorder/professional-complaints-router', function (req, res) {
...
router.all('/submit-application/recorder/other-issues-router', function (req, res) {
